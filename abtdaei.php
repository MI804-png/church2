...
// number_in_dictionary	family_code	NatID	all_name	date_of_birth	address	number_of_flat	floor	number_of_aqar	street	divide	sign	mobile	telefone	moahl	job	el_tartib_osra	your_number_in_family	khedma	notes


if($conn->connect_error){
    die("connection failed" .$conn->connect_error);
}
$sql="INSERT INTO makhdomm_abtdaei (number_in_dictionary,family_code,NatID,all_name,date_of_birth,address,number_of_flat,floor,number_of_aqar,street,divide,sign,mobile,telefone,moahl,job,el_tartib_osra,your_number_in_family,khedma,notes) 
